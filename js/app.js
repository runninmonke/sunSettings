...
var GOOGLEKEY = 'AIzaSyABG0-lKtzUkZcANns7U1qcGHQnlnUGBG0';
...
Place.prototype.getTimeZone = function() {
	var self = this;
	var url = `https://maps.googleapis.com/maps/api/timezone/json?location=${self.latLng().lat()},${self.latLng().lng()}&timestamp=${self.time.getTime()/1000}&key=${GOOGLEKEY}`;
...
mapsScript.src   = `https://maps.googleapis.com/maps/api/js?key=${GOOGLEKEY}&callback=initMap&libraries=places`;
